                    ...
                    ->tabs([
                        ...
                        ->schema([
                            ...
                            Textarea::make('excerpt_ar')
                                ...
                                ->maxLength(500)
                                ->columnSpanFull(),
                            FileUpload::make('featured_image_ar')
                                ...
                                ->imageEditor()
                                ->maxSize(5120),
                            DateTimePicker::make('published_at_ar')
                                ->label('تاريخ النشر'),
                            Toggle::make('is_published_ar')
                                ->label('منشور')
                                ->required(),
                            TextInput::make('tech_stack_ar')
                                ->label('التقنيات المستخدمة (مفصولة بفواصل)')
                                ->placeholder('لارافيل، بي إتش بي، ماي إس كيو إل، تيلويند سي إس إس')
                                ->helperText('افصل التقنيات بفواصل'),
                            TextInput::make('tags_ar')
                                ->label('الوسوم (مفصولة بفواصل)')
                                ->placeholder('#نظام_البصمات, #تكنولوجيا_التعليم, #لارافيل'),
